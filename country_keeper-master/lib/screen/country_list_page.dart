...
import 'package:note_keeper/screen/country_detail_page.dart';
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<NoteData>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            if (noteList != null) {
              if (noteList.isEmpty) {
                return Center(
                  child: Text(
                    'Bienvenido a la App de registro de Covid\n\n\n Click en el botón inferior\npara añadir un país',
          ...
          return Center(
            child: Text(
              'Click en Add para añadir un país',
              style: Theme.of(context).textTheme.bodyText2,
            ),
          );
        },
