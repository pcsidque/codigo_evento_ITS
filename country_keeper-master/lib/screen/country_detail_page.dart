...
class _NoteDetailPageState extends State<NoteDetailPage> {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: 'Ingrese casos del día'),
            ),
          ],
        ),
      ),
  ...
  void _deleteNotes() {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Eliminar '+widget.noteCompanion.title.value.toUpperCase()),
          content: Text('¿Realmente desea borrar este país?'),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(context);
